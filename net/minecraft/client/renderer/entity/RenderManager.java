...
public class RenderManager
{
    ...
    /** Renders fonts */
    private VanillaFontRenderer textRenderer;
    ...
    public void cacheActiveRenderInfo(World worldIn, VanillaFontRenderer textRendererIn, Entity livingPlayerIn, Entity pointedEntityIn, GameSettings optionsIn, float partialTicks)
    {
     ...
     */
    public VanillaFontRenderer getFontRenderer()
    {
