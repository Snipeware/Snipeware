...
public class Minecraft implements IThreadListener, IPlayerUsage
{
	...
	private void startGame() throws LWJGLException, IOException, NoSuchAlgorithmException
    {
        ...
        this.fontRendererObj = new VanillaFontRenderer(this.gameSettings, new ResourceLocation("textures/font/ascii.png"), this.renderEngine, false);
        ...
        this.standardGalacticFontRenderer = new VanillaFontRenderer(this.gameSettings, new ResourceLocation("textures/font/ascii_sga.png"), this.renderEngine, false);
        ...
        {
            this.displayGuiScreen(new GuiConnecting(new ClientMainMenu(), this, this.serverName, this.serverPort));
        }
        else
        {
    ...
    public void runTick() throws IOException
    {
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput)
        {
            ...
            while (Keyboard.next())
            {
                ...
                {
                	Client.INSTANCE.getEventManager().post(new EventKeyPress(k));
                    KeyBinding.onTick(k);
                }
