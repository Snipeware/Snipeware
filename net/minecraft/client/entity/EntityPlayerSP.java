...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public EventMotionUpdate playerEvent;
    ...
    public final boolean isMovingOnGround(){
    ...
    public void onUpdateWalkingPlayer() {
        final EventMotionUpdate event = new EventMotionUpdate(this.mc.thePlayer.posX, this.getEntityBoundingBox().minY, this.mc.thePlayer.posZ, this.mc.thePlayer.rotationYaw, this.mc.thePlayer.rotationPitch, mc.thePlayer.lastReportedYaw, mc.thePlayer.lastReportedPitch, this.mc.thePlayer.onGround, EventMotionUpdate.Type.PRE);
        Client.INSTANCE.getEventManager().post(event);
        playerEvent = event;
        ...
        if (this.isCurrentViewEntity()) {
            ...
            if (event.isRotating()) {
	            this.rotationYawHead = RenderUtil.interpolate(event.getPrevYaw(), event.getYaw(), 0);
	            this.renderYawOffset = RenderUtil.interpolate(event.getPrevYaw(), event.getYaw(), 0);
            }
    ...
    public boolean isEntityInsideOpaqueBlock() {
        final EventBlockRender blockRenderEvent = new EventBlockRender();
        Client.INSTANCE.getEventManager().post(blockRenderEvent);
    ...
    public void onLivingUpdate()
    {
        ...
        {
            final EventUseItem event = new EventUseItem();
            Client.INSTANCE.getEventManager().post(event);
