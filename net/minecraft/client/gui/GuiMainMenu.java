...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback {
	...
	private static final ResourceLocation[] titlePanoramaPaths = new ResourceLocation[] {
			new ResourceLocation("panorama/panorama_0.png"), new ResourceLocation("panorama/panorama_1.png"),
			new ResourceLocation("panorama/panorama_2.png"), new ResourceLocation("panorama/panorama_3.png"),
			new ResourceLocation("panorama/panorama_4.png"), new ResourceLocation("panorama/panorama_5.png") };
	...
	public void initGui() {
		...
		this.buttonList.add(
				new GuiButton(0, this.width / 2 - 100, j + 96, 98, 20, I18n.format("menu.options", new Object[0])));
		this.buttonList
				.add(new GuiButton(4, this.width / 2 + 2, j + 96, 98, 20, I18n.format("menu.quit", new Object[0])));
	...
	protected void actionPerformed(GuiButton button) throws IOException {
		...
		if (button.id == 14 && this.realmsButton.visible) {// Nigga moment
	...
	private void rotateAndBlurSkybox(float p_73968_1_) {
		...
		for (int k = 0; k < j; ++k) {
			...
			worldrenderer.pos((double) l, (double) i1, (double) this.zLevel).tex((double) (0.0F + f1), 1.0D)
					.func_181666_a(1.0F, 1.0F, 1.0F, f).endVertex();
	...
	public void renderSkybox(int p_73971_1_, int p_73971_2_, float p_73971_3_) {
		...
		worldrenderer.pos(0.0D, (double) l, (double) this.zLevel).tex((double) (0.5F - f), (double) (0.5F + f1))
				.func_181666_a(1.0F, 1.0F, 1.0F, 1.0F).endVertex();
		...
		if (Client.nomeaningbool) {
			...
			synchronized (this.threadLock) {
				if (this.openGLWarning1.length() > 0 && mouseX >= this.field_92022_t && mouseX <= this.field_92020_v
					...
					GuiConfirmOpenLink guiconfirmopenlink = new GuiConfirmOpenLink(this, this.openGLWarningLink, 13,
							true);
