...
public abstract class BlockLiquid extends Block
{
    ...
    {
        final EventLiquidCollide event = new EventLiquidCollide(this, pos, new AxisAlignedBB(pos.getX() + this.minX, pos.getY() + this.minY, pos.getZ() + this.minZ, pos.getX() + this.maxX, pos.getY() + this.maxY, pos.getZ() + this.maxZ));
