...
import felix.module.impl.world.Scaffold2;
...
public abstract class Entity implements ICommandSender
{
    ...
    public void moveEntity(double x, double y, double z)
    {
        ...
        else
        {
            ...
            {
            	final EventStep event = new EventStep(this, true);
    ...
    public float getCollisionBorderSize() {
    	final Hitboxes hitboxes = (Hitboxes) Client.INSTANCE.getModuleManager().getModule(Hitboxes.class);
    	if (hitboxes.isEnabled()) {
    		return hitboxes.getSize();
    	} else {
    		return 0.1F;
    	}
    }
