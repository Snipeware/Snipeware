...
public class TTFFontRenderer extends FontRenderer {
    ...
    public float drawString(final String text, final float x, final float y2, final int color) {
    ...
    public int drawStringWithShadow(final String text, final float x, final float y2, final int color) {
	...
	public void drawCenteredStringWithShadow(String text, float x, float y, int color) {
        GL11.glTranslated(0.5, 0.5, 0.0);
        this.renderString(text, x - getWidth(text) / 2, y, color, true);
        GL11.glTranslated(-0.5, -0.5, 0.0);
        this.renderString(text, x - getWidth(text) / 2, y, color, false);
	}
}
