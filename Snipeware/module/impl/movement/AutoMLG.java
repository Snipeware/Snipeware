...
import Snipeware.module.impl.world.Scaffold.BlockData;
...
public class AutoMLG extends Module {
	...
	public AutoMLG(String modName, int keybind, ModuleCategory category) {
		super(modName, keybind, category);
...
//                                
//                                float[] rotations = RotationUtils.getRotationsBlock(blockBelowData.getPosition(), blockBelowData.face);
