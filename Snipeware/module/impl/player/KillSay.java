...
public final class KillSay extends Module {
	...
	private final String[] MESSAGES2 = new String[]{"Download Snipeware", "Get Snipeware", "Get good get Snipeware!", "Snipeware on Top", "Imagine getting killed by a free client kek. download Snipeware!", "discord/snipewareclient to get good" , "LLLLLLL get Snipeware to win" , "Boom %s got sniped by Snipeware!", "%s would be better if he had snipeware :/", "get snipeware dont be like %s"};
