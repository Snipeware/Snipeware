package Snipeware.gui.alt.gui.components;
...
public class GuiPasswordField extends Gui {
    ...
    public GuiPasswordField(VanillaFontRenderer par1FontRenderer, int par2, int par3, int par4, int par5) {
    ...
    public void drawTextBox() {
        if (this.func_73778_q()) {
            ...
            if (var4.length() > 0 && var5 && var2 < var4.length()) {
                Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow(var4.substring(var2), var9, var8,
                        var1);
            }
